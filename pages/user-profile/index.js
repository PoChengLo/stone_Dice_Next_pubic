      ...
      <div style={backgroundStyle}>
        <div className={styles['container']}>
          ...
          <div className={styles['main-container']}>
            <div className={styles['main-blogs']}>
              <div className={styles['main-blog']}>
                ...
                <Image
                  ...
                  height={80}
                />
                <div className={styles['main-blog__author']}>
                  <div className={styles['author-img__wrapper']}></div>
                  <div className={styles['author-detail']}>
                    <div className={styles['author-info1']}>
                      個人圖片檔案限制 : <span className="seperate" />
                      1MB以下 .JPEG, .PNG{' '}
                    </div>
                  </div>
                </div>
              </div>
              <div className="main-blog1 anim">
                <div className="main-header anim">個人資料</div>
                ...
                <div className="main-blog__author tips">
                  ...
                  <div className={styles['author-img__wrapper']}>
                    <Image
            ...
            <div className="small-header anim">詳細資料</div>
            <div className="line anim" />
            <div className="small-header anim">電子報</div>
          </div>
        </div>
      </div>
    </>
