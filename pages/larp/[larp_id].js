  ...
  return (
    <body className={styles.larpBody}>
      ...
      <div className="position-relative">
        ...
        />
        {/* 立即預約按鈕 */}
        <Link href="#" className={styles.orderButton}>
          <svg
            width="100%"
            height={49}
            viewBox="0 0 392 49"
      ...
      <div className={styles.larpContainer}>
        ...
        <div
          ...
          style={{ padding: '0 20%', marginTop: 150 }}
        >
        ...
        >
          ...
          >
            ...
            <p
              className="primary-text d-inline"
        ...
        {/* 預約 */}
        <div id="book-group" className="d-flex" style={{ marginTop: 20 }}>
          {/* 行事曆 */}
          ...
          >
            ...
            <div className="d-flex">
              ...
              <div className="input-group">
                ...
                <select className="form-select" id="inputGroupSelect01">
                  ...
                  <option value={1}>幽靈海盜船</option>
                  <option value={2}>午夜圖書館</option>
                  <option value={3}>鬼屋實驗室</option>
                </select>
              </div>
            </div>
            {/* 日期 */}
            ...
            <div className="d-flex">
              ...
              <div className="input-group d-flex justify-content-between align-items-center">
                ...
                <h4 className="secondary-text" style={{ margin: 0 }}>
                  5,200 元
                </h4>
              </div>
            </div>
            <button
              ...
              style={{ padding: '8px 29px', marginRight: 64 }}
              type="submit"
            >
              預約
            </button>
        ...
        {/* 評論區 */}
        <div id="comment-group" className="d-flex justify-content-between">
          <div id="comment-card" className="card">
            <div className="d-flex">
              ...
              <div className="card-body">
                <h5 className="card-title">關*******</h5>
                <h6 className="card-title">2024/09/12</h6>
                <div>
                  <svg
                    width={20}
                    height={20}
